...
- (void)initView {
    ...
    self.ratioView.layer.borderColor = [CCSimpleTools stringToColor:NAVIGATIONBAR_BACKGROUND_COLOR opacity:1].CGColor;
...
- (void)initControlBtn {
    ...
    cancelBtn.frame = CGRectMake(0, self.view.frame.size.height - 50.0f, 100, 50);
    ...
    confirmBtn.frame = CGRectMake(self.view.frame.size.width - 100.0f, self.view.frame.size.height - 50.0f, 100, 50);
